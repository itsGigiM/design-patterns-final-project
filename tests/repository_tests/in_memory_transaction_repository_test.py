...
@pytest.fixture
def transaction_repo(db_executor: DatabaseExecutor) -> ITransactionRepository:
...
def test_create_Transaction(transaction_repo: ITransactionRepository) -> None:
...
def test_get_all_transactions(transaction_repo: ITransactionRepository) -> None:
...
def test_get_statistics(transaction_repo: ITransactionRepository) -> None:
